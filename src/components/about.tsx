export function About() {
    return (
        <section className="my-5 font-Montserrat font-light text-base max-md:text-sm">
            <h3 className="sr-only">
                About Lucas Prado
            </h3>
            <p>
                Hello, I'm Lucas, graduated in Analysis and Systems Development. I had the opportunity to work as a web developer, where I gained a strong knowledge of WordPress, HTML, CSS, PHP, and JavaScript. Essential skills for creating my first websites.
            </p>
            <p>
